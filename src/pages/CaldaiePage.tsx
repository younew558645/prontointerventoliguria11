  ...
  return (
    <Layout>
      <Hero
        ...
        backgroundImage="/images/caldaie11.png"
      />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="md:col-span-1 text-center">
              ...
              <p className="text-gray-600 mb-4">
                Puoi iniziare subito chiamando i nostri operatori telefonici, in modo da metterti in contatto facilmente con il tecnico caldaista più vicino.
              </p>
            </div>
      ...
      <section className="py-12 bg-light">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-6 text-dark">Riparazione Caldaie e Assistenza 24/7</h2>
          <div className="prose max-w-full text-gray-600">
            <p className="mb-4">
              La caldaia è un elemento fondamentale in ogni casa, soprattutto nei mesi invernali. Un malfunzionamento può causare disagi significativi, dal semplice mancato riscaldamento alla totale assenza di acqua calda. Il nostro servizio di riparazione caldaie è disponibile 24 ore su 24, 7 giorni su 7, per garantire interventi rapidi e risolutivi.
            </p>
            <p className="mb-4">
              I nostri tecnici specializzati sono in grado di intervenire su tutte le principali marche di caldaie, risolvendo problemi di ogni tipo, dalle semplici manutenzioni alle riparazioni più complesse. La nostra esperienza pluriennale nel settore ci permette di garantire un servizio efficiente e professionale.
            </p>

            <h3 className="text-2xl font-bold mt-8 mb-4 text-dark">Problemi comuni delle caldaie</h3>
            <p className="mb-4">
              Esistono diversi problemi che possono affliggere la tua caldaia. Ecco i più comuni che i nostri tecnici sono abituati a risolvere:
            </p>
            <ul className="list-disc pl-6 mb-4">
              <li>Caldaia che non si accende</li>
              <li>Perdite d'acqua</li>
              <li>Rumori anomali</li>
              <li>Pressione bassa o eccessiva</li>
              <li>Mancanza di acqua calda</li>
              <li>Radiatori che non si scaldano</li>
              <li>Blocchi ripetuti della caldaia</li>
              <li>Codici di errore sul display</li>
            </ul>
            <p className="mb-4">
              Non tentare riparazioni fai-da-te che potrebbero essere pericolose. Per qualsiasi problema, anche se apparentemente semplice, è sempre meglio contattare un tecnico specializzato che potrà risolvere il problema in modo sicuro e definitivo.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center">
              <img src="/images/caldaie.png" alt="Riparazione Caldaie" className="w-20 h-20 mx-auto mb-4" />
              <h3 className="font-bold text-lg mb-2 text-dark">RIPARAZIONE CALDAIE</h3>
              <p className="text-gray-600 text-sm">
                Intervento tempestivo per la riparazione di qualsiasi tipo di guasto o malfunzionamento della caldaia, con diagnosi accurata e soluzioni rapide ed efficaci.
              </p>
            </div>

            <div className="text-center">
              <img src="/images/caldaie.png" alt="Manutenzione Periodica" className="w-20 h-20 mx-auto mb-4" />
              <h3 className="font-bold text-lg mb-2 text-dark">MANUTENZIONE PERIODICA</h3>
              <p className="text-gray-600 text-sm">
                Servizi di manutenzione programmata per garantire l'efficienza della caldaia, prevenire guasti e rispettare le normative sulla sicurezza degli impianti termici.
              </p>
            </div>

            <div className="text-center">
              <img src="/images/caldaie.png" alt="Sostituzione Caldaie" className="w-20 h-20 mx-auto mb-4" />
              <h3 className="font-bold text-lg mb-2 text-dark">SOSTITUZIONE CALDAIE</h3>
              <p className="text-gray-600 text-sm">
                Fornitura e installazione di nuove caldaie delle migliori marche, con consulenza personalizzata per scegliere il modello più adatto alle tue esigenze di riscaldamento.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl text-center font-bold mb-8 text-dark">DOVE OPERIAMO | CALDAIE IN ZONA</h2>
